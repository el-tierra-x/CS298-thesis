...
\usepackage{listings-solidity} % Used for printing Solidity code in papers
\usepackage{js-listings} % Used for printing JavaScript code in papers
...
%
\def\secondCommitteeMember{Prof. Fabio Di Troia}
...
% ***** title
%
\title{PhotoProof: A Mobile Application for Verifying the Authenticity of Images}

%
% ***** author's name
%
\author{Pruthviraj Urankar}
%
% ***** graduation year
%
\copyrightyear{2025}
